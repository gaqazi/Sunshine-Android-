...
import net.elshaarawy.sunshine.data.WeatherContract.WeatherEntry;
...
//    }
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            Cv.put(WeatherContract.LocationEntry.COLUMN_LAT, lat);
            Cv.put(WeatherContract.LocationEntry.COLUMN_LONG, lon);
            Cv.put(WeatherContract.LocationEntry.COLUMN_LOCATION_SETTINGS, locationSetting);
